...
const SIGNUPS_ENABLED = process.env.NEXT_PUBLIC_SIGNUPS_ENABLED !== 'false'
  ...
  if (!SIGNUPS_ENABLED) {
    return (
      <AuthShell
        hero={
          <>
            Basar is <em className="text-[#6FB2C0]">invite-only.</em>
          </>
        }
        subcopy="Signups are closed on this demo. Use the provided demo account, or log in."
        features={[
      ...
      >
        <Card className="shadow-sm">
          <CardHeader className="items-center text-center">
            ...
            <CardDescription>
              Signups are closed on this demo. Use the provided demo account, or log in.
            </CardDescription>
          </CardHeader>
          <CardFooter>
