...
HEALTHCHECK --interval=30s --timeout=10s --start-period=40s --retries=3 \
  CMD python3 -c "import os,urllib.request,sys;bp=os.environ.get('BACKEND_PORT','8000');fp=os.environ.get('FRONTEND_PORT','3000');r1=urllib.request.urlopen(f'http://127.0.0.1:{bp}/health');r2=urllib.request.urlopen(f'http://127.0.0.1:{fp}');sys.exit(0 if r1.status==200 and r2.status==200 else 1)"
